  ...
  public static void main(String[] args) {
    ...
    do {
      ...
      if (op == 1) {
        ...
        System.out.println(" ");
        System.out.println(voo.retornarInformacaoVoo(partida, origem, partida, destino));
        System.out.println(" ");
        System.out.println("Não se esquecer dos cuidados contra o COVID! Tenha uma boa viagem!");
        System.out.println(
            "--------------------------------------------------------------------------\n\n");
